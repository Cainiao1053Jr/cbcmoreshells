...
public abstract class AbstractFlakcannonProjectile extends AbstractCannonProjectile {

	protected double displacement = 0;
	protected int ageRemaining;
	protected final Map<Player, Integer> whooshedPlayers = new HashMap<>();

	protected AbstractFlakcannonProjectile(EntityType<? extends AbstractFlakcannonProjectile> type, Level level) {
		super(type, level);
	}
