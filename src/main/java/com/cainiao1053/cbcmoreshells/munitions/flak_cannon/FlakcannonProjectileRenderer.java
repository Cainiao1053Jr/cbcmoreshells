...
///
/// reuse projectile renderer from CBC
///
public class FlakcannonProjectileRenderer<T extends AbstractFlakcannonProjectile> extends EntityRenderer<T> {
    ...
    public FlakcannonProjectileRenderer(EntityRendererProvider.Context context) { super(context); }
