...
public class APHELoiteringRocketBlock extends GeneralRackedProjectileBlock<APHELoiteringRocketProjectile> {

	private static final MapCodec<APHELoiteringRocketBlock> CODEC = simpleCodec(APHELoiteringRocketBlock::new);

	public APHELoiteringRocketBlock(Properties properties) {
		super(properties);
	}
