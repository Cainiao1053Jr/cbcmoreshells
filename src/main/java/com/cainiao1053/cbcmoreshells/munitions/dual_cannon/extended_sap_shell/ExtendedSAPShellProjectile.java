...
public class ExtendedSAPShellProjectile extends FuzedDualCannonProjectile {

	public ExtendedSAPShellProjectile(EntityType<? extends ExtendedSAPShellProjectile> type, Level level) {
		super(type, level);
	}
