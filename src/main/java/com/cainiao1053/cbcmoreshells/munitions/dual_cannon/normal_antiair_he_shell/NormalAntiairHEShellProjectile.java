...
public class NormalAntiairHEShellProjectile extends FuzedDualCannonProjectile {
	protected double yInit = 68;

	public NormalAntiairHEShellProjectile(EntityType<? extends NormalAntiairHEShellProjectile> type, Level level) {
		super(type, level);
	}
	...
	protected void detonate(Position position) {
		...
		float explosivePower = this.getAllProperties().explosion().blockDamagePower()*((this.getDurabilityModifier()-1)/1.5f+1) * explosionMultiplier;
