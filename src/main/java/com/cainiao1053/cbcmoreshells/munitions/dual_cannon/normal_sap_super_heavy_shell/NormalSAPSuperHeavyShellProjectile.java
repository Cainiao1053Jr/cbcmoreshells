...
public class NormalSAPSuperHeavyShellProjectile extends FuzedDualCannonProjectile {

	public NormalSAPSuperHeavyShellProjectile(EntityType<? extends NormalSAPSuperHeavyShellProjectile> type, Level level) {
		super(type, level);
	}
