...
public class NormalAPBCShellProjectile extends FuzedDualCannonProjectile {

	public NormalAPBCShellProjectile(EntityType<? extends NormalAPBCShellProjectile> type, Level level) {
		super(type, level);
	}
	...
	protected void detonate(Position position) {
		...
		float explosivePower = this.getAllProperties().explosion().blockDamagePower() * ((this.getDurabilityModifier()) * 0.45f + 0.4f);
	...
	public BlockState getRenderedBlockState() {
		return CBCMSBlocks.NORMAL_APBC_SHELL_BLOCK.getDefaultState();
	}
