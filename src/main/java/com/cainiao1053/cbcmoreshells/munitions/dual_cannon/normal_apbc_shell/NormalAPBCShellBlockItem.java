...
import static com.cainiao1053.cbcmoreshells.CBCMSEntityTypes.NORMAL_APBC_SHELL;
...
public class NormalAPBCShellBlockItem extends FuzedDualCannonProjectileBlockItem {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		DualCannonProperties properties = CBCMSMunitionPropertiesHandlers.DUAL_CANNON_PROPERTIES.getPropertiesOf(NORMAL_APBC_SHELL.get());
