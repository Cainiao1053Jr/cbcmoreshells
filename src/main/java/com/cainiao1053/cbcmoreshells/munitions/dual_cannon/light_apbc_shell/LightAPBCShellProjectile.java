...
public class LightAPBCShellProjectile extends FuzedDualCannonProjectile {

	public LightAPBCShellProjectile(EntityType<? extends LightAPBCShellProjectile> type, Level level) {
		super(type, level);
	}
