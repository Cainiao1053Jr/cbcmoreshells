...
//			}
		...
		if (blockBroken) {
			...
			if (!this.level().isClientSide) {
				ImpactExplosion explosion = new ImpactExplosion(this.level(), this, this.indirectArtilleryFire(false), spallLoc.x, spallLoc.y, spallLoc.z, 2, 1, Explosion.BlockInteraction.KEEP);
