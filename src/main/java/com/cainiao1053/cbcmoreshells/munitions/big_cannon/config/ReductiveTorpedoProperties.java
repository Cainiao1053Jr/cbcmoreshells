...
public record ReductiveTorpedoProperties(BallisticPropertiesComponent ballistics, EntityDamagePropertiesComponent damage,
								...
								float maxCharges, int lifetime, ReductiveProjectilePropertiesComponent reductiveProjectileProperties) {
}
