...
//					CBCMSBlocks.CAST_IRON_CANNON_END, CBCMSBlocks.BRONZE_CANNON_END
	...
	public static final BlockEntityEntry<DualCannonBlockEntity> DUAL_CANNON_BODY = REGISTRATE
			...
			.validBlocks(
					...
					CBCMSBlocks.WIDE_STEEL_SINGLE_CANNON_BARREL, CBCMSBlocks.WIDE_STEEL_SINGLE_CANNON_CHAMBER, CBCMSBlocks.WIDE_STEEL_SINGLE_CANNON_MAGAZINE,
					...
					CBCMSBlocks.LARGE_BRASS_DUAL_CANNON_BARREL, CBCMSBlocks.LARGE_BRASS_DUAL_CANNON_CHAMBER,
					...
					CBCMSBlocks.ELECTRUM_DUAL_CANNON_BARREL, CBCMSBlocks.ELECTRUM_DUAL_CANNON_CHAMBER, CBCMSBlocks.ELECTRUM_DUAL_CANNON_CHARGER,
					CBCMSBlocks.WIDE_ELECTRUM_DUAL_CANNON_BARREL, CBCMSBlocks.WIDE_ELECTRUM_DUAL_CANNON_CHAMBER, CBCMSBlocks.WIDE_ELECTRUM_DUAL_CANNON_CHARGER,
					CBCMSBlocks.ELECTRUM_SINGLE_CANNON_BARREL, CBCMSBlocks.ELECTRUM_SINGLE_CANNON_CHAMBER,
					CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_BARREL, CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_CHAMBER, CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_CHAMBER_SHIELDED,
					CBCMSBlocks.CONSTANTAN_DUAL_CANNON_BARREL, CBCMSBlocks.CONSTANTAN_DUAL_CANNON_CHAMBER, CBCMSBlocks.CONSTANTAN_DUAL_CANNON_CHARGER,
					CBCMSBlocks.WIDE_CONSTANTAN_DUAL_CANNON_BARREL, CBCMSBlocks.WIDE_CONSTANTAN_DUAL_CANNON_CHAMBER, CBCMSBlocks.WIDE_CONSTANTAN_DUAL_CANNON_CHARGER,
					CBCMSBlocks.CONSTANTAN_SINGLE_CANNON_BARREL, CBCMSBlocks.CONSTANTAN_SINGLE_CANNON_CHAMBER,
					CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_BARREL, CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_CHAMBER, CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_CHAMBER_SHIELDED
			)
			.register();
...
//					CBCMSBlocks.CAST_IRON_CANNON_END, CBCMSBlocks.BRONZE_CANNON_END
	...
	public static final BlockEntityEntry<DualCannonQuickfiringBreechBlockEntity> DUAL_CANNON_QUICKFIRING_BREECH = REGISTRATE
			...
			.validBlocks(
					...
					CBCMSBlocks.ELECTRUM_DUAL_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.WIDE_ELECTRUM_DUAL_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.ELECTRUM_SINGLE_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.ELECTRUM_SINGLE_CANNON_MAGAZINE_BREECH,
					CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_MAGAZINE_BREECH,
					CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.CONSTANTAN_DUAL_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.WIDE_CONSTANTAN_DUAL_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.CONSTANTAN_SINGLE_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.CONSTANTAN_SINGLE_CANNON_MAGAZINE_BREECH,
					CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_QUICKFIRING_BREECH,
					CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_MAGAZINE_BREECH
			)
			.register();
	...
	public static final BlockEntityEntry<DualCannonSlidingBreechBlockEntity> DUAL_CANNON_SLIDING_BREECH = REGISTRATE
			...
			.validBlocks(CBCMSBlocks.STEEL_DUAL_CANNON_SLIDING_BREECH,
					...
					CBCMSBlocks.LARGE_BRASS_DUAL_CANNON_SLIDING_BREECH,
					...
					CBCMSBlocks.ELECTRUM_DUAL_CANNON_SLIDING_BREECH,
					CBCMSBlocks.WIDE_ELECTRUM_DUAL_CANNON_SLIDING_BREECH,
					CBCMSBlocks.ELECTRUM_SINGLE_CANNON_SLIDING_BREECH,
					CBCMSBlocks.WIDE_ELECTRUM_SINGLE_CANNON_SLIDING_BREECH,
					CBCMSBlocks.CONSTANTAN_DUAL_CANNON_SLIDING_BREECH,
					CBCMSBlocks.WIDE_CONSTANTAN_DUAL_CANNON_SLIDING_BREECH,
					CBCMSBlocks.CONSTANTAN_SINGLE_CANNON_SLIDING_BREECH,
					CBCMSBlocks.WIDE_CONSTANTAN_SINGLE_CANNON_SLIDING_BREECH
			)
			.register();
	...
	public static final BlockEntityEntry<FuzedBlockEntity> FUZED_BLOCK = REGISTRATE
			...
			.validBlocks(
					...
					CBCMSBlocks.BALL,
					CBCMSBlocks.NORMAL_SAP_SUPER_HEAVY_SHELL,
					CBCMSBlocks.EXTENDED_SAP_SHELL,
